(function ($) {
    ...
    $(".wrap-slick1").each(function () {
        ...
        $(slick1).slick({
            ...
            prevArrow:
                '<button class="arrow-slick1 prev-slick1"><i class="zmdi zmdi-caret-left cl4"></i></button>',
            nextArrow:
                '<button class="arrow-slick1 next-slick1"><i class="zmdi zmdi-caret-right cl4"></i></button>',
            dots: showDot,
